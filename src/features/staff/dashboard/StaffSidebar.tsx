...
interface Props {
  active: StaffPage;
  onChange: (page: StaffPage) => void;
  onLogout: () => void;
}

export function StaffSidebar({ active, onChange, onLogout }: Props) {
  return (
    <aside
    ...
    >
      ...
      >
        ...
        <div>
          ...
          <div className="text-xs" style={{ color: "rgba(255,255,255,0.45)" }}>Staff</div>
        </div>
      </div>
